...
var help = function()
{
	...
	A=A+"Đặt mặt trắng trước mặt, đỏ bên trên, xanh lá cây bên phải  \n\n"
	A=A+"Nhập màu các mặt ( R (đỏ) / B(xanh dương) / W (trắng) / G (xanh lá) / O (cam) / Y (vàng)) \n\n";
	A=A+"Nhập màu theo vị trí từ R1 đến R9, B1 đến B9, W1 đến W9, G1 đến G9, O1 đến O9, Y1 đến Y9";
	alert(A);
}

var help2 = function()
{
	alert("Khi bật sẽ đưa ra các bước đưa khối rubik về trạng thái chưa giải");
}
